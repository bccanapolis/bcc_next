      ...
      >
        ...
        <div className="flex h-full flex-col items-center justify-between p-16">
          <div className="flex flex w-full gap-16">
            ...
            <p className="text-7xl font-semibold uppercase flex-1 inline-flex">
              {query.name}
            </p>
          </div>
          <ul className="text-3xl flex items-center justify-center gap-x-16">
            <li>
              <p className="flex items-center gap-2 text-neutral-500">
                <LattesSVG className="w-10 h-10 inline-block" /> {query.lattes}
              </p>
            </li>
            <li>
              <p className="flex items-center gap-2 text-neutral-500">
