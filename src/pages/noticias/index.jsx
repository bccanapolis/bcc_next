...
export async function getServerSideProps(context) {
  ...
  if (currentPage > maxPages) {
    ...
    context.res.setHeader('Location', `/notificas?page=${maxPages}&limit=${limit}`);
  }
...
export default function Index({
  ...
  return (<>
    ...
    <BannerBreadcrumb paths={paths} images={page.carousel}>
      <p
        className='text-5xl text-neutral-100 text-center uppercase font-semibold'>{page.hero_title || 'Noticias'}</p>
    </BannerBreadcrumb>
