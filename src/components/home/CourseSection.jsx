  ...
  return (
    <Banner childPadding={false} className={className}>
      <div className='flex flex-col lg:flex-row gap-x-12'>
          ...
          <div className='py-20 space-y-16'>
            ...
            <div className='grid gap-x-4 gap-y-8 grid-cols-1 md:grid-cols-2'>
              <div className='space-y-4'>
                ...
                <h4 className='text-lg text-neutral-100 font-medium'>Expert Instructors</h4>
                <p className='text-neutral-300 font-light'>
              ...
              <div className='space-y-4'>
                ...
                <h4 className='text-lg text-neutral-100 font-medium'>Certification</h4>
                <p className='text-neutral-300 font-light'>
                  Usage of the Internet is becoming more common due to rapid advancement of technology and power.
                </p>
              </div>
        ...
        <div className='w-full lg:w-6/12 bg-neutral-100/10 flex items-center justify-center py-20 px-10'>
          <div className='flex w-full h-full'>
            <BrazilSVG className='text-neutral-100/80'/>
          </div>
