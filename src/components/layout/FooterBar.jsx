    ...
    <>
      <footer className='bg-neutral-700'>
        <div className='grid grid-cols-2 gap-8 py-8 md:grid-cols-4 container'>
          ...
          <div>
            <h2 className='mb-6 text-sm font-semibold text-neutral-100 uppercase'>Ciência da Computação</h2>
          ...
          <div>
            <h2 className='mb-6 text-sm font-semibold text-neutral-100 uppercase'>Links Úteis</h2>
            <ul className='text-neutral-100'>
              <li className='mb-4'>
                <a href='http://cursos.ifg.edu.br/info/bach/bach-ciencia-da-computacao/CP-ANAPOLI' target='_blank' className='hover:underline'>Graduação</a>
              </li>
              <li className='mb-4'>
                <a href='https://ia.ifg.edu.br' target='_blank' className='hover:underline'>Pós-Graduação</a>
              </li>
              {/*<li className='mb-4'>*/}
          ...
          <div>
            <h2 className='mb-6 text-sm font-semibold text-neutral-100 uppercase'>Endereço</h2>
            <p className='text-neutral-100'>
              Av. Pedro Ludovico, s/n<br />Residencial Reny Cury, Anápolis<br />GO, 75131-457
            </p>
            {/*<ul className='text-neutral-100'>*/}
            {/*  <li className='mb-4'>*/}
        ...
        <div className='py-6 md:flex md:items-center md:justify-between container border-t'>
          <p className='text-sm text-neutral-100 sm:text-center'>© {new Date().getFullYear()} Ciência da Computação.
            Todos Direitos Reservados.
          </p>
          <div className='flex mt-4 space-x-6 sm:justify-center md:mt-0'>
            {/*Instagram*/}
            <a href='https://www.instagram.com/ifg.anapolis.oficial' target='_blank' rel='noreferrer'
            ...
            {/*GitHub*/}
            <a href='https://github.com/bccanapolis' target='_blank' rel='noreferrer'
               className='text-neutral-100 hover:text-primary transition-colors duration-300'>
              <svg className='w-5 h-5' fill='currentColor' viewBox='0 0 24 24' aria-hidden='true'>
                <path fillRule='evenodd'
        ...
        <div className='pb-6 container'>
          <p className='text-sm text-neutral-100 sm:text-center'>Desenvolvido com <a
            ...
            target='_blank' rel='noreferrer'>Code Tower</a></p>
        </div>
      </footer>
    </>
  );
